...
const SidebarItem = (props) => {
    ...
    const unselectedClasses = " select-none flex flex-row items-center text-nebula-grey-600 text-sm h-12 my-4 font-semibold border-l-4 border-transparent hover:bg-nebula-grey-400 ";
