                    ...
                    <button className="lg:hidden focus:outline-none" onClick={this.expandCollapseSidebar}>
                        {
                            this.state.expanded
                                ...
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M18.7308 6.27295L6.7308 18.2729" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M6.7308 6.27295L18.7308 18.2729" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                :
