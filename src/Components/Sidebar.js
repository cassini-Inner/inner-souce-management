...
class Sidebar extends Component {
    ...
    render() {
        ...
        return (
            <div className="w-1/5 px-2 h-screen sticky top-0 text-black bg-nebula-grey-200 border border-r-1 border-l-0 border-nebula-grey-400">
                <div className="w-full">
                    <div className="text-2xl pt-12 pb-6 pl-3 font-bold">
                        Nebula
                    </div>
                </div>
