...
class Sidebar extends Component {
    ...
    render() {
        ...
        return (
            <div className="w-auto border-l-0 sticky top-0 text-black bg-nebula-grey-200 border-nebula-grey-400 border border-r-0 px-2 lg:w-84 lg:h-screen lg:border-r-1 lg:border-b-0 lg:border-l-0">
