...
const SplitContainer = (props) => {
    ...
    return (
        <div className="bg-white flex flex-col mx-auto xl:shadow-lg ">
            ...
            <div className="flex w-full justify-start flex-col md:flex-row sticky bottom-0 border-t border-nebula-grey-400">
                {
                    props.actions ?
