        ...
        <Link to = { "/jobDetails/"+props.data.id} >
            ...
            key={props.data.id}>
                ...
                <div className="flex flex-wrap items-center my-4">
                    <div className="flex flex-1 flex-wrap justify-evenly items-center md:justify-start">
                        <div
                ...
                <div className="flex flex-col flex-wrap mt-4 justify-left md:flex-row">
                    <div className="flex-1">
                        <div className="flex items-center">
                            <div><StatusTags statusTag={[props.data.status.toLowerCase(), props.data.viewerHasApplied ? "applied" : ""]} /></div>
