...
const JobCard = (props) => {
    return (
        <div className = {"w-full p-6 bg-white mt-5 rounded-lg " + (props.manageJobs ? "" : "transition duration-300 shadow-none cursor-pointer hover:shadow-lg border border-nebula-grey-400")} key={props.data.title}>
