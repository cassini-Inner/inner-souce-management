            ...
            id={props.data.id}>
            {
                props.isSelected ?
                    <div className="flex text-nebula-blue items-center m-2">
                        <p className="hover:text-black"><CheckSquare /></p>
                        <p className="ml-3">Selected</p>
                    </div>
                    :
                    <div className="flex items-center m-2">
                        <p className="hover:text-nebula-blue"><Square /></p>
            ...
            <div className="p-6">
                ...
                <div
                    ...
                    <div className="py-4 md:py-0">
                        <p className="cursor-pointer text-sm font-semibold text-nebula-blue hover:text-blue-700">
                            View Details
                        </p>
                    </div>
                </div>
